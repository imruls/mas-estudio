...
(`src/assets/partners/modugno.jpg` y `alvarez-schiaffino.jpg`) son fotos
...
igual con un comentario `// TODO: reemplazar por foto real` en
`DataSite.ts`, para que no se pierda de vista antes de producción.
